...
class Log
{
    ...
    public static function eleve_add($id, $nom, $prenom, $classe, $num_carte){
        ...
        $db->query("INSERT INTO Journalisation VALUES (NULL, '$id', '$num_carte', '$date', '$evenement')", 'Coac\Table\Log');
    ...
    public static function promos_add($name){
        ...
        $db->query("INSERT INTO Journalisation VALUES (NULL, NULL, NULL, '$date', '$evenement')", 'Coac\Table\Log');
